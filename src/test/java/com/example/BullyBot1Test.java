...
public class BullyBot1Test {
     ...
     */
    @Test
    public void fireCannonNotEnoughEnergy() {
     ...
     */
    @Test
    public void fireCannonNoTargets() {
     ...
     */
    @Test
    public void fireCannonMoreTargetThanEnergy() {
        TimBot t = new BullyBot(42, 4);
        t.startRound();
        int [] spressoSensed = {0, 10, 10, 10, 10};
        boolean [] botsSensed = {false, true, true, true, true};
     ...
     */
    @Test
    public void fireCannonLessTargetThanEnergy() {
